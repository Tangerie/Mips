            ...
            Tok::Word(w) => match w {
                ...
                Wrd::Instruction(i) => match i {
                    ...
                    Inst::AddImmediateUnsignedWord => {
                        write!(fmtr, "[Instruction] Add Immediate Unsigned Word")
                    }
                    Inst::SubtractWord => write!(fmtr, "[Instruction] Subtract Word"),
                    Inst::SubtractUnsignedWord => {
                        write!(fmtr, "[Instruction] Subtract Unsigned Word")
                    }
                    ...
                    Inst::MultiplyUnsignedWord => {
                        write!(fmtr, "[Instruction] Multiply Unsigned Word")
                    }
                    Inst::MultiplyandAddWordtoHiLo => {
                        write!(fmtr, "[Instruction] Multiply and Add Word to Hi, Lo")
                    }
                    Inst::MultiplyandAddUnsignedWordtoHiLo => write!(
                        fmtr,
                        "[Instruction] Multiply and Add Unsigned Word to Hi, Lo"
                    ),
                    Inst::MultiplyandSubtractWordtoHiLo => {
                        write!(fmtr, "[Instruction] Multiply and Subtract Word to Hi, Lo")
                    }
                    Inst::MultiplyandSubtractUnsignedWordtoHiLo => write!(
                        fmtr,
                        "[Instruction] Multiply and Subtract Unsigned Word to Hi, Lo"
                    ),
                    ...
                    Inst::RemainderafterWordDivision => {
                        write!(fmtr, "[Instruction] Remainder after Word Division")
                    }
                    Inst::RemainderafterUnsignedWordDivision => {
                        write!(fmtr, "[Instruction] Remainder after Unsigned Word Division")
                    }
                    Inst::CountLeadingOnesinWord => {
                        write!(fmtr, "[Instruction] Count Leading Ones in Word")
                    }
                    Inst::CountLeadingZeroesinWord => {
                        write!(fmtr, "[Instruction] Count Leading Zeroes in Word")
                    }
                    ...
                    Inst::SetonLessThanorEqual => {
                        write!(fmtr, "[Instruction] Set on Less Than or Equal")
                    }
                    Inst::SetonLessThanorEqualUnsigned => {
                        write!(fmtr, "[Instruction] Set on Less Than or Equal Unsigned")
                    }
                    Inst::SetonLessThan => write!(fmtr, "[Instruction] Set on Less Than"),
                    Inst::SetonLessThanUnsigned => {
                        write!(fmtr, "[Instruction] Set on Less Than Unsigned")
                    }
                    Inst::SetonGreaterThanorEqual => {
                        write!(fmtr, "[Instruction] Set on Greater Than or Equal")
                    }
                    Inst::SetonGreaterThanorEqualUnsigned => {
                        write!(fmtr, "[Instruction] Set on Greater Than or Equal Unsigned")
                    }
                    Inst::SetonLessThanImmediate => {
                        write!(fmtr, "[Instruction] Set on Less Than Immediate")
                    }
                    Inst::SetonLessThanImmediateUnsigned => {
                        write!(fmtr, "[Instruction] Set on Less Than Immediate Unsigned")
                    }
                    ...
                    Inst::NegateValueUnsigned => {
                        write!(fmtr, "[Instruction] Negate Value Unsigned")
                    }
                    ...
                    Inst::ExclusiveOrImmediate => {
                        write!(fmtr, "[Instruction] Exclusive Or Immediate")
                    }
                    ...
                    Inst::RotateWordRightVariable => {
                        write!(fmtr, "[Instruction] Rotate Word Right Variable")
                    }
                    Inst::ShiftWordLeftLogical => {
                        write!(fmtr, "[Instruction] Shift Word Left Logical")
                    }
                    Inst::ShiftWordLeftLogicalVariable => {
                        write!(fmtr, "[Instruction] Shift Word Left Logical Variable")
                    }
                    Inst::ShiftWordRightArithmetic => {
                        write!(fmtr, "[Instruction] Shift Word Right Arithmetic")
                    }
                    Inst::ShiftWordRightArithmeticVariable => {
                        write!(fmtr, "[Instruction] Shift Word Right Arithmetic Variable")
                    }
                    Inst::ShiftWordRightLogical => {
                        write!(fmtr, "[Instruction] Shift Word Right Logical")
                    }
                    Inst::ShiftWordRightLogicalVariable => {
                        write!(fmtr, "[Instruction] Shift Word Right Logical Variable")
                    }
                    ...
                    Inst::LoadHalfwordUnsigned => {
                        write!(fmtr, "[Instruction] Load Halfword Unsigned")
                    }
                    ...
                    Inst::Pushregistertostack => {
                        write!(fmtr, "[Instruction] Push register to stack")
                    }
                    Inst::Popregisterfromstack => {
                        write!(fmtr, "[Instruction] Pop register from stack")
                    }
                    ...
                    Inst::MoveConditionalonZero => {
                        write!(fmtr, "[Instruction] Move Conditional on Zero")
                    }
                    Inst::MoveConditionalonNotZero => {
                        write!(fmtr, "[Instruction] Move Conditional on Not Zero")
                    }
                    ...
                    Inst::BranchonEqualtoZero => {
                        write!(fmtr, "[Instruction] Branch on Equal to Zero")
                    }
                    Inst::BranchonNotEqual => write!(fmtr, "[Instruction] Branch on Not Equal"),
                    Inst::BranchonNotEqualtoZero => {
                        write!(fmtr, "[Instruction] Branch on Not Equal to Zero")
                    }
                    Inst::BranchonGreaterThanorEqual => {
                        write!(fmtr, "[Instruction] Branch on Greater Than or Equal")
                    }
                    Inst::BranchonUnsignedGreaterThanorEqual => write!(
                        fmtr,
                        "[Instruction] Branch on Unsigned Greater Than or Equal"
                    ),
                    Inst::BranchonGreaterThanorEqualtoZero => write!(
                        fmtr,
                        "[Instruction] Branch on Greater Than or Equal to Zero"
                    ),
                    Inst::BranchonGreaterThan => {
                        write!(fmtr, "[Instruction] Branch on Greater Than")
                    }
                    Inst::BranchonUnsignedGreaterThan => {
                        write!(fmtr, "[Instruction] Branch on Unsigned Greater Than")
                    }
                    Inst::BranchonGreaterThanZero => {
                        write!(fmtr, "[Instruction] Branch on Greater Than Zero")
                    }
                    Inst::BranchonLessThan => write!(fmtr, "[Instruction] Branch on Less Than"),
                    Inst::BranchonUnsignedLessThan => {
                        write!(fmtr, "[Instruction] Branch on Unsigned Less Than")
                    }
                    Inst::BranchonLessThanZero => {
                        write!(fmtr, "[Instruction] Branch on Less Than Zero")
                    }
                    Inst::BranchonLessThanorEqual => {
                        write!(fmtr, "[Instruction] Branch on Less Than or Equal")
                    }
                    Inst::BranchonUnsignedLessThanorEqual => {
                        write!(fmtr, "[Instruction] Branch on Unsigned Less Than or Equal")
                    }
                    Inst::BranchonLessThanorEqualtoZero => {
                        write!(fmtr, "[Instruction] Branch on Less Than or Equal to Zero")
                    }
                    Inst::BranchonGreaterThanorEqualtoZeroandLink => write!(
                        fmtr,
                        "[Instruction] Branch on Greater Than or Equal to Zero and Link"
                    ),
                    Inst::BranchonLessThanZeroandLink => {
                        write!(fmtr, "[Instruction] Branch on Less Than Zero and Link")
                    }
                    ...
                    Inst::JumpandLinkRegister => {
                        write!(fmtr, "[Instruction] Jump and Link Register")
                    }
